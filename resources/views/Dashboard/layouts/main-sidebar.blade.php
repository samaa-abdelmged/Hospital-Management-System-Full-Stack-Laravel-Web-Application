    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            @can('viewAny', \App\Models\Section::class)
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('post') }}"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span class="side-menu__label"> المنشورات</span></a>
                </li>
            @endcan
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item"
                            href="{{ route('Sections.index') }}">{{ trans('main-sidebar_trans.view_all') }}</a>
                    </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item"
                            href="{{ route('Doctors.index') }}">{{ trans('main-sidebar_trans.view_all') }}</a>
                    </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item"
                            href="{{ route('insurance.index') }}">{{ trans('main-sidebar_trans.Insurance') }}</a>
                    </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('Patients.create') }}">
                            {{ trans('main-sidebar_trans.add_patient') }}</a></li>
                    <li><a class="slide-item"
                            href="{{ route('Patients.index') }}">{{ trans('main-sidebar_trans.patients_list') }}</a>
                    </li>
                </ul>
            </li>
            <li class="slide">
